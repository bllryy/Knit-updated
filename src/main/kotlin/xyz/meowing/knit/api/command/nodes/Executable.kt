...
import xyz.meowing.knit.api.command.parsers.ParserArgumentType
...
class Executable : Node() {
     ...
     *
     * Classes that already have a parser provided: [String], [GreedyString][xyz.meowing.knit.api.command.utils.GreedyString],
     * [Int], [Long], [Float], [Double], [Boolean].
     *
     * To create custom parsers,
     * you can either:
     *
     * - Apply the [CommandParsable][xyz.meowing.knit.api.command.parsers.CommandParsable]
